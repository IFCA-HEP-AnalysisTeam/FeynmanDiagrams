...
Representative Feynman diagram at LO for ZZZ process production at the LHC collider in Figure~\ref{fig:ZZZ}
\vspace{5mm}
...
\end{fmffile}
\vspace{2mm}
    \caption{Representative tree-level diagrams for triboson process ZZZ}
    \label{fig:ZZZ}
\end{figure}